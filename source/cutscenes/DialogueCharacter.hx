...
class DialogueCharacter extends FlxSprite
{
	...
	public static var DEFAULT_CHARACTER:String = 'sen';
	...
	public var curCharacter:String = 'sen';
	...
	public function new(x:Float = 0, y:Float = 0, character:String = null)
	{
		...
		frames = Paths.getSparrowAtlas(jsonFile.image);
		reloadAnimations();
	...
	public function reloadCharacterJson(character:String) {
		var characterPath:String = 'images/portraits/' + character + '/ports.json';
		var rawJson = null;
