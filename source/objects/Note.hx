...
class Note extends FlxSprite
{
		...
		if(noteData > -1 && noteType != value) {
			switch(value) {
				case 'dusty':
					...
					hitCausesMiss = true;
					noteSplashData.texture = 'mechanics/AVOIDnoteSplash';
				...
				case 'avoidnote':
					...
					noteSplashData.useRGBShader = false;
					lowPriority = true;
					missHealth = 0; //This is 25% I think?
					hitCausesMiss = true;
					noteSplashData.texture = 'mechanics/AVOIDNOTESplash_Assets';
					hitsoundChartEditor = false;
				case 'Hurt Note':
					ignoreNote = mustPress;
	...
	public function new(strumTime:Float, noteData:Int, ?prevNote:Note, ?sustainNote:Bool = false, ?inEditor:Bool = false, ?isPlayer:Bool = false, ?createdFrom:Dynamic = null)
	{
		super();
	...
	function addCustomNote(type:String) {// pain
		...
		{
			case 'targetnote':
				frames = Paths.getSparrowAtlas('mechanics/TARGETNOTE_asset');
				loadNoteAnims();
				animation.play(lastAnimToPlay + 'Scroll');
			case 'dusty':
				frames = Paths.getSparrowAtlas('mechanics/AVOIDNOTE_assset');
				loadNoteAnims();
				animation.play(lastAnimToPlay + 'Scroll');
			case 'avoidnote':
				frames = Paths.getSparrowAtlas('mechanics/AVOIDNOTEFour_Assets');
				loadNoteAnims();
				animation.play(lastAnimToPlay + 'Scroll');
		}
		updateHitbox();
