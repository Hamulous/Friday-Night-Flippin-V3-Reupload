...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['BG Goons Anim Type', "Should be used only in \"philly\" Stage!"],
		['Decay Triggers', "if ykyk"],
		['ease camzoom','val1 & val2: zoom,time'],
		['cancel camera tweens','']
	];
	...
	**/
	...
	var composerCreditInputText:FlxUIInputText;
	...
	function addDataUI()
	{
		...
		composerCreditInputText = new FlxUIInputText(10, gameOverEndInputText.y + 35, 150, _song.musicCredit != null ? _song.musicCredit : '', 8);
		blockPressWhileTypingOn.push(composerCreditInputText);
		...
		tab_group_data.add(composerCreditInputText);
		...
		tab_group_data.add(new FlxText(composerCreditInputText.x, composerCreditInputText.y - 15, 0, 'Composer Credit'));
	...
	override function getEvent(id:String, sender:Dynamic, data:Dynamic, ?params:Array<Dynamic>)
	{
		...
		else if (id == FlxUINumericStepper.CHANGE_EVENT && (sender is FlxUINumericStepper))
		{
			...
			else if(sender == composerCreditInputText) {
				_song.musicCredit = composerCreditInputText.text;
			}
