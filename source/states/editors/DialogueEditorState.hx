...
class DialogueEditorState extends MusicBeatState
{
	...
	function addDialogueLineUI() {
		...
		{
			updateTextBox();
			dialogueFile.dialogue[curSelected].boximage = (angryCheckbox.checked ? 'angry' : 'normal');
		};
	...
	function reloadCharacter() {
		character.frames = Paths.getSparrowAtlas(character.jsonFile.image);
	...
	function changeText(add:Int = 0) {
		...
		angryCheckbox.checked = (curDialogue.boximage == 'angry');
